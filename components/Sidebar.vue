  ...
  >
    <div class="flex justify-between px-4">
      <div class="flex items-center space-x-5">
        <div class="bg-white px-3 py-2 rounded-2xl">
          <img
            class="logo-right float-right"
            :src="require(`@/assets/bbalogo.png`)"
          />
        </div>
      </div>
    ...
    <nav class="space-y-4">
      ...
      >
        ...
        <span class="font-semibold text-md">Role</span>
      </nuxt-link>
      <nuxt-link
      ...
      >
        ...
        <span class="font-semibold text-md">Certificates</span>
      </nuxt-link>
      <nuxt-link
        to="/admin/settings"
        class="
